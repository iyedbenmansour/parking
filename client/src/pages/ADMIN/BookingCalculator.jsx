...
const BookingCalculator = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        setFilteredBookings(filteredData); // Set filtered bookings
  ...
  const handleDeleteConfirmation = (bookingId) => {
    // Implement delete logic here or show a confirmation dialog
  };
    ...
    <div>
      ...
      <div className="mainContentArea">
        <div className="bookingForm">
          <h2>Live Booking Counts by airport and zone  and Zone</h2>
                ...
                <li key={index} className="booking-item">
                  ...
                  <div className="booking-details">
                    <p
                      ...
                      onClick={() => goToUserDetails(booking.email)}
                    >
                      Email: {booking.email}
                    </p>
